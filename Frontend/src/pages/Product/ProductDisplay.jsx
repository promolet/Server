...
const ProductDetail = () => {
  ...
  const handleBuyNow = () => {
    navigate(`/billing/${product.title}/${product._id}`, {
      state: {
        type: "single",
      },
    });
...
>
                    ...
                    <div
                      class="accordion accordion-flush product-accordion"
                          ...
                          <div class="accordion-body">
                            <div class="bordered-box border-0 mt-0 pt-0">
                              ...
                              <ul class="shipping-info">
                                ...
                                <li>
                                  <span>Capacity: </span>
                                  {product.capacity} {product.capacityUnits}
                                </li>
                                <li>
                                  <span>Unit Type: </span>
                                  {product.typeOfUnit}
                                ...
                                <li>
                                  <span>Quantity: </span>
                                  {product.quantity || "40 Items Left"}
                                </li>
                              </ul>
                            </div>
                            ...
                            <div class="bordered-box">
                              ...
                              <ul class="delivery-details">
                                <li>
                                  <i class="ri-truck-line"></i> Your order is
                                  likely to reach you within 7 days.
                                </li>
                                <li>
